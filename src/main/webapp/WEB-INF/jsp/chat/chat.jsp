        ...
        <div chat class="am-tab-panel">
            <div class="am-panel am-panel-default" style="height: 85%;">
                ...
                <div class="am-panel-bd" style="height: 30%;padding: 0px 0px 0px 0px;">
                    <textarea style="min-width: 100%;max-width: 100%;min-height: 100%;max-height: 100%"></textarea>
                </div>
            </div>
            <div class="am-form-group" style="width: 100%">
                <button type="button" class="am-btn am-btn-secondary am-btn-sm" style="width: 25%;float: right;">发送</button>
            </div>
        </div>
